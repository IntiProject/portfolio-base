  ...
  return (
    <section className="relative pt-20 pb-10" id="game">
      <div className="wobbly-border-2 relative overflow-hidden border-4 border-on-background bg-secondary-fixed p-8 shadow-[12px_12px_0px_0px_rgba(29,28,23,1)]">
        ...
        <div
          ref={areaRef}
          className="relative cursor-crosshair overflow-hidden rounded-lg border-4 border-on-background bg-surface-container-highest shadow-inner select-none"
          style={{ width: '100%', maxWidth: GAME_WIDTH, height: GAME_HEIGHT, margin: '0 auto' }}
          onPointerMove={handlePointerMove}
        >
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(#000_1px,transparent_1px)] bg-size-[20px_20px] opacity-10" />
          ...
          {items.map((item) => (
            ...
            >
              <span
                className="material-symbols-outlined rounded-full border-2 border-on-background bg-surface p-1 text-3xl shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
          ...
          {pops.map((pop) => (
            <div
              key={pop.id}
              className="pointer-events-none absolute animate-bounce text-xl font-black"
          ...
          >
            <div className="relative">
              <div className="wobbly-border-2 relative flex h-20 w-24 items-center justify-center border-x-4 border-b-4 border-on-background bg-surface shadow-[4px_4px_0px_0px_rgba(29,28,23,0.2)]">
                <div className="absolute -top-2 right-0 left-0 h-4 rounded-full border-4 border-on-background bg-surface-container-highest" />
                <span className="material-symbols-outlined text-4xl text-on-background/20">
                  water_drop
                </span>
              </div>
